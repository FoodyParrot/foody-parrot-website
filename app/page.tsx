  ...
  const pageData = {
    ...
    targetAudience: {
      ...
      items: get(homeContent, 'home.targetAudience.items', [
        { icon: '', title: 'Food Consumers', description: 'Discover new recipes, share food experiences, and connect with fellow food lovers.' },
    ...
    features: {
      ...
      items: get(homeContent, 'home.features.items', [
        { icon: '', title: 'Latest Gists', description: 'Fresh conversation starters dropped daily by Foody Parrot. Never run out of things to talk about.', gradient: 'from-[#5BBB69] to-[#4A9A56]' },
