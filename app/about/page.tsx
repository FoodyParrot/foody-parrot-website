  ...
  const pageData = {
    ...
    team: {
      ...
      members: get(aboutContent, 'about.team.members', [
        { name: 'Alex Rivera', role: 'Founder & CEO', emoji: '👨‍💼', bio: 'Visionary leader with 10+ years in social tech. Believes food brings people together.' },
        { name: 'Priya Sharma', role: 'CTO', emoji: '👩‍💻', bio: 'Tech wizard who built scalable platforms at top startups. Loves clean code and spicy food.' },
        { name: 'Marcus Chen', role: 'Head of Design', emoji: '🎨', bio: 'Award-winning designer crafting delightful experiences. Obsessed with perfect pixels.' },
        { name: 'Sofia Laurent', role: 'Head of Community', emoji: '🤝', bio: 'Community builder extraordinaire. Connects people through shared love of great food.' },
        { name: 'James Okonkwo', role: 'Lead Developer', emoji: '⚡', bio: 'Full-stack expert turning ideas into reality. Coffee enthusiast and bug hunter.' },
        { name: 'Yuki Tanaka', role: 'Marketing Director', emoji: '📈', bio: 'Growth hacker with viral campaign success. Believes in authentic brand stories.' },
      ]),
    },
  };
